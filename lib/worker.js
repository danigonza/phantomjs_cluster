...
var processing = function(app, params, serverConfig, callback) {
...
// bits of logic
var processImageUsingCache = function(filePath, url, callback) {
  if (url) {
    // Asynchronous
    climService.console.info("Will post screenshot to %s when processed", url);
